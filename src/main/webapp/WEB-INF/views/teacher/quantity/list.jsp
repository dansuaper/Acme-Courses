...
<acme:list>
	...
	<acme:list-column code="teacher.quantity.list.label.caption" path="tutorial.caption"/>
...
<acme:button code="teacher.quantity.list.button.create" action="/teacher/quantity/create?id=${id}"/>