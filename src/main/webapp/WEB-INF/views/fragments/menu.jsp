...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.administrator" access="hasRole('Administrator')">
			<acme:menu-suboption code="master.menu.administrator.post.create" action="/administrator/post/create"/>	
			<acme:menu-separator/>
		...
		<acme:menu-option code="master.menu.teacher" access="hasRole('Teacher')">
			...
			<acme:menu-suboption code="master.menu.teacher.list-proposed-help-requests" action="/teacher/help-request/list-proposed"/>
